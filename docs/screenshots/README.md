...
| Filename | Page | Notes |
|---|---|---|
| `landing.png` | `/` while **logged out** | The intro/marketing page with the feature cards. |
| `browse-events.png` | `/` while **logged in** as a customer | The events list. |
...
but worth filling in before sharing the repo for review.
